...
el pack recién generado. La idea —exportar dos policies y reconciliar CIDs— está inspirada en el
flujo legacy->current de QualysTBX, pero acá es 100% de LECTURA (no hay import/merge) y la lógica
es propia.
